...
exports.createAndUpdateGroupsFromJwt = function(params) {
	...
	var createAndUpdateGroupsOnLogin = isSet(idProviderConfig.createAndUpdateGroupsOnLogin) ? idProviderConfig.createAndUpdateGroupsOnLogin : true;
	log.debug('createAndUpdateGroupsOnLogin:' + toStr(createAndUpdateGroupsOnLogin));

	if(!createAndUpdateGroupsOnLogin) { return; }
	var dnFormat = idProviderConfig.groups	&& idProviderConfig.groups.dn || '${dn}';
