...
* Create a rule to send LDAP attributes as claims for the created Relying Party Trust
** A window allowing you to define Issuance Transform Rules must have opened on the previous step.
